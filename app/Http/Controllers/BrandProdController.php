...
//        $lcompany = DB::table('mtl_company')->get();
        //$lcompany = DB::table('mtl_company')->get();
        //$ltypeProduk=
        //return view('master.brand_produk.create', compact('lcompany')
        //);

        $lcompany = DB::table('mtl_company')->get();
        $ltypeproduct = DB::table('type_produk')->get();
        return view('master.brand_produk.create', compact('lcompany','ltypeproduct')
        );          
...
//        return view('master.brand_produk.index',['BrandPro' => $BrandPro]);
    ...
    {
        //
        //$EditBrand = MtlBrandProduk::find($id);
        //return view('master.brand_produk.edit',['EditBrand' => $EditBrand]);
        
        $lcompany = DB::table('mtl_company')->get();
        $ltypeproduct = DB::table('type_produk')->get();
       
        $EditBrand = MtlBrandProduk::find($id);
        return view('master.brand_produk.edit',['EditBrand' => $EditBrand],compact('lcompany','ltypeproduct'));
