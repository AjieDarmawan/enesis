...
class ImportExcelController _bck extends Controller
{
    /**
    * Return View file
    * @var array
    ...
    public function getFleet(){
        ...
        foreach ($summary as $value){ 
                ...
                if ($ttlcarton<$value['minFleetCrt']) {
                    ...
                    $fleetKe=1;
                    $details=sortBy($details)->reverse()->toArray();
                    $DefineFleet=$this->DefineCDD($value['num'], $datedlv,$ttlcarton, $value['minFleetCrt'],$value['minFleetVal'],$value['minFleetType'],$sisaMin, $fleetKe,$fleetKe);
                }
                else {
