...
class ProdukController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('master.produk.create', compact('lbrand')
        ); 
    }
    ...
    public function store(Request $request)
    {
        ...
        //    'active' => 'required'
        //    );
        $rules = array('inventory_item_id' => 'required|unique:mtl_produk');
    ...
    public function edit($id)
    {
       ...
       //  $lbrand = DB::table('mtl_produk')->get();
       
       
        //$Edit = MtlProduk::find($id);
        //return view('master.produk.edit',['Edit' => $Edit],compact('lbrand'));
