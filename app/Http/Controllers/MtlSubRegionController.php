...
class MtlSubRegionController extends Controller
{
    ...
    public function store(Request $request)
    {
        //
         $rules = array(
            'id_region' => 'required|:mtl_subregion',
            'subregion' => 'required|:mtl_subregion',
    ...
    public function edit($id)
    {
        ...
        return view('master.subregion.edit',['EditKat' => $edit],compact('lsubreg'));
