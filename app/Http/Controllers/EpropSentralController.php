    ...
    */
	...
	public function InputSentra() {
       ...
       // dd($division);
        ...
        return view('eprop.eprop_sentra_1', compact('person_name', 'person_id','yearNow','year5', 'company', 'brand', 'user_activity','ListVarian','executors'));
...
//         dd($det_prop_activity, $det_prop_brand,$det_prop_varian, $det_prop_branch, $det_prop_executor, $det_prop_division, $det_prop_market);
    ...
    public function PostSecondMTPage(Request $request)  {
		...
		//dd($det_prop_brand, $det_prop_executor, $det_prop_branch, $det_prop_activity, $det_prop_account, $det_prop_varian);
