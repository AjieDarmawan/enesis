...
<link rel="stylesheet" href="https://cdn.datatables.net/responsive/1.0.4/css/dataTables.responsive.css">
 ...
 -->
   ...
   <link rel="stylesheet" href="{{ asset('vendor/admin-lte/plugins/dataTables/dataTables.responsive.css')}}">
   <link rel="stylesheet" href="{{ asset('vendor/admin-lte/plugins/dataTables/dataTables.tableTools.min.css')}}">
...
<div class="wrapper">
 <!-- Main Header -->
    ...
    <script src="{{ asset('vendor/admin-lte/dist/js/demo.js')}}"></script>
     ...
     <script src="{{ asset('vendor/admin-lte/plugins/dataTables/jquery.dataTables.js')}}"></script>
     <script src="{{ asset('vendor/admin-lte/plugins/dataTables/dataTables.bootstrap.js')}}"></script>
     <script src="{{ asset('vendor/admin-lte/plugins/dataTables/dataTables.responsive.js')}}"></script>
     <script src="{{ asset('vendor/admin-lte/plugins/dataTables/dataTables.tableTools.min.js')}}"></script>
