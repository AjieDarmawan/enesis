...
-->
        <div class="form-group">
          <label class="col-xs-2 control-label">Company Id</label>
            <div class="col-xs-6">
              <select class="form-control select2" multiple="multiple" style="width: 75%;" id="company_id"  name="company_id" type="text">
...
<!--
        <div class="form-group">
          <label class="col-xs-2 control-label">Product type</label>
            <div class="col-xs-6">
              <select class="form-control select2" multiple="multiple" style="width: 75%;" id="product_type"  name="product_type" type="text">
                  <option value = "">  -- Product type -- </option>
                  @foreach($ltypeproduct as $value)
                    <option value = "{{$value->value_name}}" > {{$value->value_name}} </option>
                  @endforeach
              </select>
            </div>
        </div>
