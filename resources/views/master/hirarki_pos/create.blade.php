...
@section('content_header')
	  <h1>
        Add New Hirarki Pos Limit
        <small>Tambah Hirarki Pos Limit</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Master</a></li>
        <li class="active">Create Hirarki Pos Limit</li>
      </ol>  
@stop

@section('content')
<form class="form-horizontal form-group-sm" method="POST" action="{{ route('hirarki_pos.store') }}">
  <div class="row">
