...
@section('content_header')
       <h1>
        ...
        <small>Report Result Program Paramater</small>
      </h1>
      <ol class="breadcrumb">
...
<section class="content">
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
                        @if(session('message'))
                          ...
                          @endif
              <h3 class="box-title">Report Result Program Paramater</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="row">
          <form class="" method="POST" action="{{route('result_implementation.cari')}}">
              {{ csrf_field() }}
