...
@section('content_header')
       <h1>
        ...
        <small>Report Auto Closed Parameter</small>
      </h1>
      <ol class="breadcrumb">
...
<section class="content">
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
                        @if(session('message'))
                          ...
                          @endif
              <h3 class="box-title">Report Auto Closed Parameter</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="row">
          <form class="" method="POST" action="{{route('auto_closed.cari')}}">
              {{ csrf_field() }}
             ...
             <div class="form-group">
               <label>Excekutor</label>
                  <select class="form-control" name="executor_name">
                      <option value="">--Pilih Excekutor--</option>
