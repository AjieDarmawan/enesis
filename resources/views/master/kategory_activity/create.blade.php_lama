            ...
            <select class="form-control select2" style="width: 75%;" name="budget_type" id="budget_type" type="text">
             ...
             <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                <label>
                  <input checked="checked" type="checkbox" name="flag_region" id="flag_region" value="Y">Flag Region
                </label>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                <label>
                  <input checked="checked" type="checkbox" name="flag_mt" id="flag_mt" value="Y">Flag MT
                </label>
                </div>
              </div>
            </div>
