        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Result Form</h3>
               <a href="">Export</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  ...
                  <?php
                   ...
                   <tr>
                     ...
                     <td>   </td>
                     <td><a href="{{ route('result.edit',$value->budget_detail_id) }}" class="btn btn-success btn-sm">Input Actual</a></td>
                     </tr>
                   @endforeach
