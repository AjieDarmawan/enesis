    ...
    <div class="box box-danger">
      ...
      <br>
       <div class="form-group">
          ...
          <div class="col-xs-3">
            <input type="text" value="{{ $EditJob->job_code }}" id="job_code" name="job_code" class="form-control" required/> 
          </div>
        </div>
        <div class="form-group">
          <label class="col-xs-2 control-label">Job Description</label>
          <div class="col-xs-3">
            <input type="text" value="{{ $EditJob->job_description }}" id="job_name" name="job_description" class="form-control" required/> 
          </div>
        </div>
       <div class="form-group">
