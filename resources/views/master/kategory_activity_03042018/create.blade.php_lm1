	  ...
	  <div class="box box-danger">
       ...
       <div class="form-group">
        ...
        <label class="col-xs-2 control-label">Budget Type</label>
          <div class="col-xs-6">
            <select class="form-control select2" style="width: 75%;" name="budget_type" id="budget_type" type="text">
                <option value = ""> </option>
             ...
             <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                <label>
                  <input checked="checked" type="checkbox" name="flag_region" id="flag_region" value="Y" required>Flag Region
                </label>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                <label>
                  <input checked="checked" type="checkbox" name="flag_mt" id="flag_mt" value="Y" required>Flag MT
                </label>
                </div>
              </div>
            </div>
