      ...
      <div class="form-group">
          ...
          <div class="col-xs-3">
            <select class="form-control select2" style="width: 75%;" name="hirarky_type" id="hirarky_type" type="text" data-placeholder='-- Piih Hirarki Type --'>
              @if(Session::has('ArrHirarki'))
                @foreach($ArrHirarki as $key => $value)
                  <option value="{{ $value['hirarky_type']}}"> {{ $value['hirarki_typename'] }} </option>
                @foreach
              @else
                <option></option>
              @endif
        ...
        <div class="col-md-9 box box-danger">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div>
                    <a href="#" class="btn btn-success btn-xs"><i class="fa fa-fw fa-hand-o-up"></i>Up</a>
                  </div> 
                </div>
              </div>
            <div class="col-md-8 box box-danger">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div>
                    <a href="#" class="btn btn-success btn-xs"><i class="fa fa-fw fa-hand-o-down"></i>Down</a>
                  </div>
                </div>
              </div>
            </div>
