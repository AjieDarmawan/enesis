...
@section('content')
<form class="form-horizontal form-group-sm" method="POST" action="{{ route('region.update',['id' => $EditKat->id]) }}">
  <div class="row">
    ...
    <div class="box box-danger">
      ...
      <br>
       <div class="form-group">
          ...
          <div class="col-xs-3">
            <input type="text" value="{{ $EditKat->region }}" id="region" name="region" class="form-control" required/> 
          </div>
        </div>
           <div class="form-group">
