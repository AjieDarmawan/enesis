    ...
    <div class="box box-danger">
      ...
      <br>
         ...
         <div class="form-group">
          ...
          <div class="col-xs-3">
              <input type="text" name="budget_detail_id" id="budget_detail_id" value="{{$Batal->budget_detail_id}}" class="form-control" readonly="" /> 
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label">status</label>
            <div class="col-xs-4">
              <select class="form-control select2" style="width: 75%;" name="status" id="status" type="text" data-placeholder='-- Pilih --'>
                  <option></option>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-3">
            <input type="text" name="reason" id="reason" style="width: 100%;" class="form-control" required/> 
            </div>   
        </div>
         <div class="form-group">
           <div class="col-xs-3">
