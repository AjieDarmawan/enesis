    ...
    <div class="box box-danger">
      ...
      <br>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-3">
            <input type="text"  id="division_code" name="division_code"   placeholder="division_code" class="form-control" required/> 
          </div>   
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-3">
            <input type="text"  id="division_name" name="division_name"   placeholder="division_name" class="form-control" required/> 
          </div>   
        </div>
