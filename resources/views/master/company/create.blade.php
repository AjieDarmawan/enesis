...
@section('content')
<form class="form-horizontal form-group-sm" method="POST" action="{{ route('company.store') }}">
  <div class="row">
    ...
    <div class="box box-danger">
      ...
      <br>
        <div class="form-group">
          ...
          <div class="col-xs-3">
            <input type="text"  id="company_code" name="company_code"   placeholder="Company Code" class="form-control" required/> 
          </div>   
        </div>
