 ...
 <div class="row">
    <div class="col-md-12">
        <div class="box box-danger">
          <form class="form-horizontal form-group-sm" method="POST" action="{{ url('upload_excel') }}">
            <!-- Headers -->
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                      @if(Session::has('trx_rkp'))
                          @foreach(Session::get('trx_rkp') as $value)
                          ...
                          @endforeach
                          @else
                            <input type="text" name="periode" id="periode" class="form-control service" readonly="true" required/>
                       @endif  
                  </div>  
                </div>
            </div>
            ...
            <div class="col-xs-8">
              <div class="box-body">
                <table id="tbldetails" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @if(Session::has('trx_detail'))
                    @foreach(Session::get('trx_detail')->sortBy('delivery_date')  as $value)
                    <tr>
            ...
            <div class="box-footer">
               <a href="{{ url('/home') }}" class="btn btn-warning btn-sm">Cancel</a>
                ...
                @else
                    ...
                    <button type="submit" class="btn btn-info pull-right"  href="{{ route('save_orders') }}" >Submit</button>  
                @endif 
            </div>
            <!-- End Of Box Footer --> 
          </form>
