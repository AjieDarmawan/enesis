    ...
    <div class="col-xs-12">
      <div class="box box-danger">
            ...
            <div class="col-md-4">
              <select class="form-control select2" multiple="multiple" style="width: 75%;" name="store_mt[]" id="store_mt" type="text"> 
                @foreach($store as $value)
                    ...
                    @foreach (Session::has('det_prop_store') as $pilihan)
        ...
        <div class="form-group"> 
            ...
            <div class="col-md-5">
              <Input type="number" name="total_buget" id="total_buget" style="font-size: 15px;"  value= "{{ $epropAmount }}" required="required">
            </div>          
        </div>
        ...
        <div class="form-group"> 
            ...
            <div class="col-md-5">
              <textarea class="form-control" rows="2" name="background" id="background"  value= "{{ $background }}" required="required"></textarea>
            </div>          
        </div>
        ...
        <div class="form-group"> 
            ...
            <div class="col-md-5">
              <textarea class="form-control" rows="2"   name="objective" id="objective" value= "{{ $objective }}" required="required"></textarea>
            </div>          
        </div>
        <div class="form-group"> 
            <label class="col-sm-2 control-label">Mechanism</label>
            <div class="col-md-5">
              <textarea class="form-control" rows="2"  name="mechanism" id="mechanism" value= "{{ $mechanism }}"  required="required"></textarea>
            </div>          
        </div>
        <div class="form-group"> 
            <label class="col-sm-2 control-label">Estimate Cost</label>
            <div class="col-md-5">
              <textarea class="form-control" rows="2"  name="estimate_cost" id="estimate_cost"  value= "{{ $estimate_cost }}" required="required"></textarea>
            </div>          
        </div>
        <div class="form-group"> 
            <label class="col-sm-2 control-label">KPI</label>
            <div class="col-md-5">
              <textarea class="form-control" rows="2"  name="kpi" id="kpi" value= "{{ $kpi }}"  required="required"></textarea>
            </div>          
        </div>
      <!--box danger --> 
      </div>  
