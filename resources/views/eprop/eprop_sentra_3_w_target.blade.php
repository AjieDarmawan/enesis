...
@section('content')
<form class="form-horizontal form-group-sm" method="POST" action="{{ route('PostThridPage') }}">
	<div class="row">
    ...
    <div class="col-xs-12">
      <div class="box">
         ...
         <a href="{{ route('SentraPrevPage2') }}" class="btn bg-maroon btn-sm margin pull-right"><< Prev Page </a>
